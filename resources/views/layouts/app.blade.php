    ...
    <div class="container mx-auto px-4 py-2">
        <div class="flex items-center justify-between">
            ...
            <div class="hidden lg:flex items-center space-x-2">
                @if(session('admin_logged_in'))
                    <a href="{{ route('dashboard.index') }}" class="px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors font-medium {{ request()->routeIs('dashboard.index') ? 'bg-green-50 text-green-700' : '' }}">
                        📊 Dashboard
                    </a>
                    <a href="{{ route('dashboard.settings') }}" class="px-4 py-2 rounded-lg font-medium transition-colors {{ request()->routeIs('dashboard.settings') ? 'bg-yellow-50 text-yellow-700' : 'text-gray-700 hover:bg-gray-100' }}">
                        ⚙️ Configuración
                    </a>
        ...
        <div id="mobileMenu" class="lg:hidden hidden mt-4 pb-4 border-t pt-4">
            <div class="flex flex-col space-y-2">
                <a href="{{ route('dashboard.index') }}" class="px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors {{ request()->routeIs('dashboard.index') ? 'bg-green-50 text-green-700 font-semibold' : '' }}">
                    📊 Dashboard
                </a>
                <a href="{{ route('dashboard.settings') }}" class="px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors {{ request()->routeIs('dashboard.settings') ? 'bg-yellow-50 text-yellow-700 font-semibold' : '' }}">
                    ⚙️ Configuración
                </a>
